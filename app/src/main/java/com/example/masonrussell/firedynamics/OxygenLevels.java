...
public class OxygenLevels extends AppCompatActivity {
    ...
    List<String> t2GrowthRateList = new ArrayList<>(), graphOptionsList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ValueClassStorage.oxygenLevels != null)
        {
            ValueClassStorage.OxygenLevels oxygenLevels = ValueClassStorage.oxygenLevels;
            roomWidthValue.setText(String.valueOf(oxygenLevels.roomWidthDoub));
            roomWidthUnitSpinner.setSelection(2);
            roomLengthValue.setText(String.valueOf(oxygenLevels.roomLengthDoub));
            roomLengthUnitSpinner.setSelection(2);
            roomHeightValue.setText(String.valueOf(oxygenLevels.roomHeightDoub));
            roomHeightUnitSpinner.setSelection(2);
            initialO2Value.setText(String.valueOf(oxygenLevels.initialOxygenPercentDoub*100));
            if (oxygenLevels.fireType.equals("Steady State Fire"))
            {
                typeOfFireSelectionSpinner.setSelection(0);
                heatReleaseRateValue.setText(String.valueOf(oxygenLevels.qDoub));
                resultsParams.height = 0;
                t2Params.height = 0;
                t2FireLayout.setLayoutParams(t2Params);
                t2FireLayout.setVisibility(View.INVISIBLE);
            ...
            else if (oxygenLevels.fireType.equals("t^2 Fire"))
            {
                typeOfFireSelectionSpinner.setSelection(1);
                timestepValue.setText(String.valueOf(oxygenLevels.timestepDoub));
                t2FireGrowthRateSpinner.setSelection(t2GrowthRateList.indexOf(oxygenLevels.time));
                graphSelectionSpinner.setSelection(graphOptionsList.indexOf(oxygenLevels.graphType));
                steadyStateFireParams.height = 0;
                steadyStateFireLayout.setLayoutParams(steadyStateFireParams);
                steadyStateFireLayout.setVisibility(View.INVISIBLE);
                t2Params.height = LinearLayout.LayoutParams.WRAP_CONTENT;
    ...
    {
        t2GrowthRateList.add("Fast");
        t2GrowthRateList.add("Medium");
        t2GrowthRateList.add("Slow");
        t2GrowthRateList.add("Ultrafast");
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, t2GrowthRateList);
        dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerToMake.setAdapter(dataAdapter);
    }
    ...
    {
        graphOptionsList.add("Q Over Time");
        graphOptionsList.add("Total Energy Over Time");
        graphOptionsList.add("Total O2 Consumed Over Time");
        graphOptionsList.add("Total Percent O2 In Room");
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, graphOptionsList);
        dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerToMake.setAdapter(dataAdapter);
    }
